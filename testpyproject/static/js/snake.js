    ...
    */
    ...
    return function(inputConfig) {
        ...
        function createWelcomeElement() {
            ...
            welcomeTxt.innerHTML = "Python Game<p></p>Use the <strong>arrow keys</strong> on your keyboard to play the game. " + fullScreenText + "<p></p>";
        ...
        function createTryAgainElement() {
            ...
            tryAgainTxt.innerHTML = "Python Game<p></p>You died :(.<p></p>";
        ...
        */ 
        me.handleDeath = function() {
            ...
            $.ajax({
                url: setScoreUrl,
                type: 'POST',
                data: { score: mySnake.snakeLength },
                success: function (data) {
                    console.log()
                    $('#game_result_info .count_of_games').text(data.count_of_games);
                    $('#game_result_info .best_score').text(data.best_score);
                    $('#game_result_info .last_score').text(data.last_score);
                    return true;
                }
            });
